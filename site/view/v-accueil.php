...
<div id="medecouvrir" class="container_pres ">
        ...
        <a href="src/medias/cv.pdf" download="Mon CV">Télécharger mon Cv</a>
</div>
<?php endforeach; ?>
        ...
        <?php foreach ($projets as $projet): ?>
            <div class="card cache">
                ...
                <div class="expandMoreHolder">
                    <span expand-more data-hidetext="Montrer moins" data-showtext="En savoir plus..." data-target="showMoreContent1" class="btn-expand-more">En savoir plus...</span>
                </div>
                </div>
            </div>
        <?php endforeach; ?>
            ...
            <div class="row">
                ...
                <div class="footer-col">
                    ...
                    <div class="social-links">
                        <a href="https://github.com/Theoode" target="_blank"><img src="src/medias/github.png"></a>
                        <a href="https://www.linkedin.com/in/th%C3%A9o-quennehen-41939423a/" target="_blank"> <img src="src/medias/linkedin.png"></a>
                    </div>
                </div>
            </div>
        </div>
